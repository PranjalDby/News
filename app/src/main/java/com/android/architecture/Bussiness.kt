...
class Bussiness : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var country:String = intent.getStringExtra("country").toString();
        factory = MainActivityViewModelFactory("business",country)
        ...
        model.getDashBoardLive().observe(this, Observer {
            if(it.status.equals("ok")){
                ...
                searchView1.visibility = SearchView.GONE
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        try {
            ...
            searchView1 = item?.actionView as SearchView
            searchView1.setOnQueryTextListener(
